...
protected:
  virtual void SetUp() { m_fileSystem.Mount( "disk", new DiskFileDevice( "../../tests/Assets" ) ); };
};
...
TEST_F( ImageFixture, GetColourAt_ValidParameters_ShouldReturnWhiteColour )
{
  ...
  // act
  Colour colour =
    image.getColourAt( 80, 30 ); ///< The center of the image is white.  Has a curved edge with a blueish border.
