#ifndef NEBULAE_SOURCE_NEBULAE_COMMON_PIXEL_PIXELFORMAT_H_
#define NEBULAE_SOURCE_NEBULAE_COMMON_PIXEL_PIXELFORMAT_H_
...
enum PixelFormat : uint16
{
  ...
  PF_FLOAT16_RGB = 22,
  // 64-bit pixel format, 16 bits (float) for red, 16 bits (float) for green, 16 bits (float) for blue, 16 bits (float)
  // for alpha
  PF_FLOAT16_RGBA = 23,
  ...
  PF_FLOAT32_RGB = 24,
  // 128-bit pixel format, 32 bits (float) for red, 32 bits (float) for green, 32 bits (float) for blue, 32 bits (float)
  // for alpha
  PF_FLOAT32_RGBA = 25,
...
#endif // NEBULAE_SOURCE_NEBULAE_COMMON_PIXEL_PIXELFORMAT_H_
