...
void DiskFile::Seek( size_t position ) { m_stream->seekg( position, std::ios_base::beg ); }

void DiskFile::SeekToEnd() { m_stream->seekg( 0, std::ios_base::end ); }

void DiskFile::Skip( size_t bytes ) { m_stream->seekg( bytes, std::ios_base::cur ); }
