#ifndef NEBULAE_COMMON_FILESYSTEM_MANIFESTDISKFILEDEVICE_H_
#define NEBULAE_COMMON_FILESYSTEM_MANIFESTDISKFILEDEVICE_H_
...
#endif // NEBULAE_COMMON_FILESYSTEM_MANIFESTDISKFILEDEVICE_H_
