...
std::size_t Nebulae::file_read( void* ptr, std::size_t size, std::size_t nmemb, void* datasource )
{
...
unsigned Nebulae::file_write( void* ptr, unsigned size, unsigned nmemb, void* datasource )
{
  File& stream = *static_cast<File*>( datasource );
