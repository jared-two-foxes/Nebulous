...
ManifestDiskFileDevice::~ManifestDiskFileDevice() { delete m_fallback; }
...
void ManifestDiskFileDevice::LoadManifestFromFile( const std::string& filepath,
...
File* ManifestDiskFileDevice::Open( File* file ) { return m_fallback->Open( file ); }

void ManifestDiskFileDevice::Close( File* file ) { m_fallback->Close( file ); }
