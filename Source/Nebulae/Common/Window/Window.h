#ifndef NEBULAE_SOURCE_NEBULAE_COMMON_WINDOW_WINDOW_H_
#define NEBULAE_SOURCE_NEBULAE_COMMON_WINDOW_WINDOW_H_
...
#endif // NEBULAE_SOURCE_NEBULAE_COMMON_WINDOW_WINDOW_H_