#ifndef NEBULAE_SOURCE_NEBULAE_COMMON_WINDOW_INPUTLISTENER_H_
#define NEBULAE_SOURCE_NEBULAE_COMMON_WINDOW_INPUTLISTENER_H_
...
#endif // NEBULAE_SOURCE_NEBULAE_COMMON_WINDOW_INPUTLISTENER_H_