...
{
// constructor
Variant::Variant() : m_Type( Variant::Unknown ), m_iValue( -1 ) {}

// constructor
Variant::Variant( int iValue ) : m_Type( Variant::Int ), m_iValue( iValue ) {}

// constructor
Variant::Variant( float fValue ) : m_Type( Variant::Float ), m_fValue( fValue ) {}

// constructor
Variant::Variant( const char* szValue ) : m_Type( Variant::String )
{
...
// IsInt
bool Variant::IsInt() const { return ( m_Type == Variant::Int ); }

// IsFloat
bool Variant::IsFloat() const { return ( m_Type == Variant::Float ); }

// IsString
bool Variant::IsString() const { return ( m_Type == Variant::String ); }
