#ifndef NEBULAE_COMMON_BASE_TYPES_DISTRIBUTIONSERIALIZER_H_
#define NEBULAE_COMMON_BASE_TYPES_DISTRIBUTIONSERIALIZER_H_
...
{
public:
  template <class T> void Serialize( const Json::Value& value, Distribution<T>& distribution );
};


template <>
void DistributionSerializer::Serialize<Vector4>( const Json::Value& value, Distribution<Vector4>& distribution )
{
  if ( !value["x"].isArray() )
  {
    Vector4 constant;
...
#endif // NEBULAE_COMMON_BASE_TYPES_DISTRIBUTIONSERIALIZER_H_
