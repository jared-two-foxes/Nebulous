...
void Clock::Init() { m_impl->Init(); }

void Clock::MarkThisTick() { m_impl->Mark(); }

uint64 Clock::GetAccurateTime() const { return m_impl->GetAccurateTime(); }

uint64 Clock::GetElapsedTime() const { return m_impl->GetElapsedTime(); }

uint64 Clock::GetUpTime() const { return m_impl->GetUpTime(); }