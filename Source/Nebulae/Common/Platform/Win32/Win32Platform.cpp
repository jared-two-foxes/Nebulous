...
KeyCode VirtualKeyFromWindowsKey( unsigned short key, Flags<ModKey> mods )
{
  ...
  case VK_OEM_MINUS:
    ...
    break;
  case VK_BACK:
    retval = VKC_BACKSPACE;
    break;
  case VK_TAB:
    retval = VKC_TAB;
    break;
  case VK_OEM_4:
    retval = VKC_LEFTBRACKET;
    break;
  case VK_OEM_6:
    retval = VKC_RIGHTBRACKET;
    break;
  case VK_RETURN:
    retval = VKC_RETURN;
    break;
  ...
  case VK_OEM_PERIOD:
    ...
    break;
  case VK_OEM_3:
    retval = VKC_BACKQUOTE;
    break;
  case VK_OEM_5:
    retval = VKC_BACKSLASH;
    break;
  case VK_RSHIFT:
    retval = VKC_RSHIFT;
    break;
  case VK_MULTIPLY:
    retval = VKC_KP_MULTIPLY;
    break;
  case VK_LMENU:
    retval = VKC_LALT;
    break;
...
void Win32Platform::SetWorkingDirectory( const char* directory )
{
