...
std::shared_ptr<Nebulae::Platform> impl::CreatePlatformImpl() { return std::make_shared<Nebulae::Win32Platform>(); }
...
std::shared_ptr<Nebulae::Platform> Nebulae::CreateAndInitiatePlatform() { return impl::CreatePlatformImpl(); }