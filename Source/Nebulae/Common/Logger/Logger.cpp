...
void Logger::Register( std::ostream& os, bool immediate )
{
  if ( immediate )
  {
...
void Logger::Unregister( std::ostream& os )
{
...
const std::vector<std::string>& Logger::GetMessages() const { return m_messages; }