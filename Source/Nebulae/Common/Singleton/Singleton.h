#ifndef NEBULAE_COMMON_SINGLETON_SINGLETON_H_
#define NEBULAE_COMMON_SINGLETON_SINGLETON_H_
...
public:
  ...
  static T* GetPtr()
  {
    NE_ASSERT( ms_instance, "Attempting to access uninitialized singleton." );
    return ms_instance;
  }
  static T& Get()
  {
...
#endif // NEBULAE_COMMON_SINGLETON_SINGLETON_H_
