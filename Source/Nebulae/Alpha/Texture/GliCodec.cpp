...
Nebulae::PixelFormat EnginePixelFormatFromGli( gli::format format )
{
  // FORMAT_UNDEFINED = 0,
...
ImageCodecData* GliCodec::Decode( File& is ) const
///
...
ImageCodecData* GliCodec::ConvertFromRawBits( uint8* bits, PixelFormat sourceFormat, std::size_t width,
