...
public:
  ...
  */
  ...
  /** Stores a pointer to raw data in memory. The pixel format has to be specified.
    ...
    */
  Image& loadDynamicImage( uint8* data, std::size_t width, std::size_t height, std::size_t depth, PixelFormat format,
                           bool autoDelete = false, std::size_t numFaces = 1, std::size_t numMipMaps = 0 );
  ...
  static std::size_t calculateSize( std::size_t mipmaps, std::size_t faces, std::size_t width, std::size_t height,
