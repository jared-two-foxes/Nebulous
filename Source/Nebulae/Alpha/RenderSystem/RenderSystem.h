#ifndef NEBULAE_ALPHA_RENDERSYSTEM_RENDERSYSTEM_H_
#define NEBULAE_ALPHA_RENDERSYSTEM_RENDERSYSTEM_H_
...
public:
  ...
  // factory functions.
  HardwareBuffer* CreateBuffer( const std::string& identifier, const Flags<HardwareBufferUsage>& usage,
                                std::size_t sizeInBytes, HardwareBufferBinding bindFlags, void* sysMem,
                                bool shouldLoad = true );
  InputLayout* CreateInputLayout( const std::string& identifier, const VertexDeceleration* pVertexDecl,
                                  const HardwareShader* pVertexShader, bool shouldLoad = true );
  RenderTexture* CreateRenderTexture( const std::string& identifier, int32 width = -1, int32 height = -1,
                                      bool shouldLoad = true );
...
#endif // NEBULAE_ALPHA_RENDERSYSTEM_RENDERSYSTEM_H_
