...
const RenderSystem::WindowPtr RenderSystem::GetWindow() const { return m_window; }

bool RenderSystem::Initiate()
{
...
void RenderSystem::SetDepthTest( bool /*enable*/ ) {}

void RenderSystem::BeginScissorClipping( Point /*ul*/, Point /*lr*/ ) {}

void RenderSystem::EndScissorClipping() {}

void RenderSystem::BeginStencilClipping( Point /*inner_ul*/, Point /*inner_lr*/, Point /*outer_ul*/,
                                         Point /*outer_lr*/ )
{
}

void RenderSystem::EndStencilClipping() {}

HardwareBuffer* RenderSystem::CreateBuffer( const std::string& identifier, const Flags<HardwareBufferUsage>& usage,
                                            std::size_t sizeInBytes, HardwareBufferBinding bindFlags, void* sysMem,
                                            bool shouldLoad )
{
...
InputLayout* RenderSystem::CreateInputLayout( const std::string& identifier, const VertexDeceleration* pVertexDecl,
...
RenderTexture* RenderSystem::CreateRenderTexture( const std::string& identifier, int32 width, int32 height,
                                                  bool shouldLoad )
{
  if ( width == -1 )
...
HardwareBuffer* RenderSystem::FindBufferByName( const std::string& identifier ) const
{
  return m_bufferFactory->FindByName( identifier.c_str() );
}

InputLayout* RenderSystem::FindInputLayoutByName( const std::string& identifier ) const
{
...
RenderTexture* RenderSystem::FindRenderTextureByName( const std::string& identifier ) const
{
  return m_renderTextureFactory->FindByName( identifier.c_str() );
}

HardwareShader* RenderSystem::FindShaderByName( const std::string& identifier ) const
{
  return m_shaderFactory->FindByName( identifier.c_str() );
}

Sampler* RenderSystem::FindSamplerByName( const std::string& identifier ) const
{
  return m_samplerFactory->FindByName( identifier.c_str() );
}

Texture* RenderSystem::FindTextureByName( const std::string& identifier ) const
{
  return m_textureFactory->FindByName( identifier.c_str() );
}

Texture* RenderSystem::FindTextureByIdentifier( int32 identifier ) const
{
  return m_textureFactory->FindByIdentifier( identifier );
}

void RenderSystem::SetClearColour( float /*r*/, float /*g*/, float /*b*/, float /*a*/ ) {}

void RenderSystem::SwapBuffers() {}

void RenderSystem::SetVertexBuffers( int /*iSlot*/, /*int iCount,*/ HardwareBuffer* /*pBufferImpl*/,
                                     std::size_t /*iStride*/, std::size_t /*iOffset*/ )
{
}

void RenderSystem::SetInputLayout( InputLayout* /*pInputLayoutImpl*/ ) {}

void RenderSystem::SetIndexBuffer( HardwareBuffer* /*pBuffer*/, size_t /*iOffset*/ ) {}

void RenderSystem::SetRenderTexture( RenderTexture* /*pRenderTexture*/ ) {}

void RenderSystem::SetShaders( HardwareShader* /*vertexShader*/, HardwareShader* /*fragmentShader*/ ) {}

void RenderSystem::SetOperationType( OperationType /*eType*/ ) {}

void RenderSystem::Draw( std::size_t /*iVertexCount*/, std::size_t /*iStartVertexLocation*/ ) {}

void RenderSystem::DrawIndexed( std::size_t /*iIndexCount*/, std::size_t /*iStartIndexLocation*/,
...
RenderTextureImpl* RenderSystem::CreateRenderTextureImpl( int32 /*width*/, int32 /*height*/ ) { return nullptr; }

HardwareShaderImpl* RenderSystem::CreateShaderImpl( const std::string& /*strFileName*/, HardwareShaderType /*eType*/ )
{
  return nullptr;
}

InputLayoutImpl* RenderSystem::CreateInputLayoutImpl( const VertexDeceleration* /*pVertexDecl*/,
                                                      const HardwareShader* /*pVertexShader*/ )
{
  return nullptr;
}

Sampler::Impl* RenderSystem::CreateSamplerImpl() { return nullptr; }

TextureImpl* RenderSystem::CreateTextureImpl( const std::string& /*strName*/ ) { return nullptr; }
