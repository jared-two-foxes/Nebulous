...
int32 Resource::GetIdentifier() const { return m_identifier; }


const std::string& Resource::GetName() const { return m_name; }


bool Resource::IsLoaded() const { return ( m_loadingStatus == LoadingStatus::Loaded ); }


bool Resource::Load( File* is )
{
