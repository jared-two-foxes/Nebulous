...
const Flags<HardwareBufferUsage> Nebulae::HBU_DYNAMIC_WRITE_ONLY_DISCARDABLE( ( Nebulae::HBU_DYNAMIC |
                                                                                Nebulae::HBU_WRITE_ONLY |
                                                                                Nebulae::HBU_DISCARDABLE ) );
...
void HardwareBuffer::WriteData( std::size_t offset, std::size_t length, const void* pSource, bool discardWholeBuffer )
{
...
bool HardwareBuffer::IsLocked() const { return m_isLocked; }

void* HardwareBuffer::Lock( std::size_t offset, size_t length, LockOptions options )
{
