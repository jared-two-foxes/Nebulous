...
void DebugUtil::Reset() { m_primitiveCount = 0; }


void DebugUtil::AddLine( const Vector4& p1, const Vector4& p2, const Vector4& colour )
{
  struct DebugVertex
  {
    float position[3];
...
void DebugUtil::AddCircle( const Vector4& position, const Real radius, const Vector4& colour )
{
...
void DebugUtil::Draw( const CameraPtr& camera )
{
