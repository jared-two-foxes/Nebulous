...
public:
  ...
  int RenderText( const Point& pt, const std::string& text, const Colour& colour,
  ...
  void RenderText( const Point& pt1, const Point& pt2, const std::string& text, Flags<TextFormat>& format,
                   const std::vector<Font::LineData>& line_data, RenderState& render_state, std::size_t begin_line,
                   CPSize begin_char, std::size_t end_line, CPSize end_char ) const;
