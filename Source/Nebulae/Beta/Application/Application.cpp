...
void Application::Initiate( int w, int h )
///
...
uint64 Application::ProcessApplicationLoop( uint64 elapsed )
{
  if ( !m_pRenderSystem )
  {
    return 0;
...
void Application::ProcessSimulation( [[maybe_unused]] uint64 fTimeElapsed )
///
...
void Application::ProcessFrame( [[maybe_unused]] uint64 fTimeElapsed )
///
...
Application::PlatformPtr Application::CreatePlatform()
///
...
void Application::Setup( int w, int h )
///
...
Application::WindowPtr Application::CreateApplicationWindow( int w, int h )
///
/// Creates and returns a Window.
///
/// @todo [jared.watt 14/02/2013]
///   Currently initialized to default values.  Need to be initialized to the device dimensions if no sizes are
///   specified..
///
{
...
void Application::SetMainWindow( WindowPtr window )
///
...
bool Application::IsInitialized() const { return m_bInitialized; }

Application::PlatformPtr Application::GetPlatform() const { return m_pPlatform; }

Application::RenderSystemPtr Application::GetRenderSystem() const { return m_pRenderSystem; }

bool Application::HasInputListener( InputListener* listener ) const
///
