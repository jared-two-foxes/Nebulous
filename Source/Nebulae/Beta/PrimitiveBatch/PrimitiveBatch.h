#ifndef NEBULAE_BETA_PRIMITIVEBATCH_PRIMITIVEBATCH_H_
#define NEBULAE_BETA_PRIMITIVEBATCH_PRIMITIVEBATCH_H_
...
public:
  PrimitiveBatch( RenderSystemPtr renderSystem, size_t maxIndices = DefaultBatchSize * 3,
      ...
      m_inputLayout( nullptr )
  {
    ...
    // m_indexBuffer = renderSystem->CreateBuffer( "", HBU_DYNAMIC_WRITE_ONLY, maxIndices * sizeof(uint16_t), HBB_INDEX,
    // nullptr );
  ...
  void Begin( Effect* effect )
  {
    if ( m_boundEffect != effect )
    {
      ...
      m_inputLayout =
        m_renderSystem->CreateInputLayout( "batch_layout", m_decleration, m_boundEffect->GetVertexShader() );
    }
...
private:
  ...
  void Draw( OperationType topology, bool isIndexed, uint16_t const* indices, size_t indexCount, size_t vertexCount,
             void** ppMappedVertices )
  {
...
#endif // NEBULAE_BETA_PRIMITIVEBATCH_PRIMITIVEBATCH_H_
