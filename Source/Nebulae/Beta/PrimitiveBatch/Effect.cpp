...
const Nebulae::HardwareShader* Effect::GetVertexShader() const { return m_vertexShader; }

const Nebulae::HardwareShader* Effect::GetPixleShader() const { return m_pixelShader; }


Effect::Effect() : m_vertexShader( nullptr ), m_pixelShader( nullptr ) {}
...
void Effect::Init( RenderSystemPtr renderDevice )
{
...
void Effect::Apply( Effect::RenderSystemPtr renderDevice )
{
...
void Effect::SetWorld( Matrix4 value ) { m_world = value; }


void Effect::SetView( Matrix4 value ) { m_view = value; }


void Effect::SetProjection( Matrix4 value ) { m_projection = value; }


void Effect::SetMatrices( Matrix4 world, Matrix4 view, Matrix4 projection )
{
  m_world = world;
  m_view = view;
