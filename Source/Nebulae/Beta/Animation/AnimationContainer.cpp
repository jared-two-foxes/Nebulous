...
// addAnimation
void AnimationContainer::addAnimation( Animation* animation ) { m_Animations.push_back( animation ); }

// getAnimation
Animation* AnimationContainer::getAnimation( int idx ) const { return m_Animations[idx]; }

// addSkeleton
void AnimationContainer::addSkeleton( Skeleton* skel ) { m_Skeletons.push_back( skel ); }

// getSkeleton
Skeleton* AnimationContainer::getSkeleton( int idx ) const { return m_Skeletons[idx]; }
