...
// TODO: Havok uses a hkAnimationBinding to handle binding an animation to a skeleton rather than directly referencing
// the animation 		in the hkAnimationControl class.  Implement something similar?
