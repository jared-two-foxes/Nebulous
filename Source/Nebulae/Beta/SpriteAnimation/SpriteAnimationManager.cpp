...
SpriteAnimationManager::SpriteAnimationManager( const FileArchivePtr& fileSystem, const AtlasManagerPtr& atlasManager )
  : m_fileSystem( fileSystem ), m_atlasManager( atlasManager )
{
}
...
SpriteAnimation* SpriteAnimationManager::Create( const std::string& name )
{
...
SpriteAnimation* SpriteAnimationManager::GetByName( const std::string& name ) const
{
