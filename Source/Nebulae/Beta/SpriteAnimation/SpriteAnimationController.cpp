...
SpriteAnimationController::SpriteAnimationController( RenderSystemPtr renderDevice, Material* material,
                                                      SceneNode* pNode )
...
void SpriteAnimationController::Play( const SpriteAnimation* pAnimation, int iDisplayFlags )
{
...
void SpriteAnimationController::SetCompleteCallback( std::function<void()>& animationCompleteCallback,
                                                     void* callbackContext )
{
  m_animationCompleteCallback = animationCompleteCallback;
}

void SpriteAnimationController::SetPlaybackSpeed( float seconds_per_frame )
{
