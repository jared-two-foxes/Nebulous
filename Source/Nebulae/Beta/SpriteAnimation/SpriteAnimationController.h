#ifndef NEBULAE_BETA_SPRITEANIMATION_SPRITEANIMATIONCONTROLLER_H_
#define NEBULAE_BETA_SPRITEANIMATION_SPRITEANIMATIONCONTROLLER_H_
...
private:
  ...
  std::function<void()>
    m_animationCompleteCallback; ///< Callback function to be invoked when the animation is complete.
...
#endif // NEBULAE_BETA_SPRITEANIMATION_SPRITEANIMATIONCONTROLLER_H_