...
SpriteAnimation::SpriteAnimation( const std::string& strName, const AtlasManagerPtr& atlasManager )
  : m_name( strName ), m_atlasManager( atlasManager )
{
}
...
const std::string& SpriteAnimation::GetName() const { return m_name; }


std::size_t SpriteAnimation::GetFrameCount() const { return m_Frames.size(); }


SpriteAnimationFrame* SpriteAnimation::GetFrame( std::size_t idx ) const { return m_Frames[idx]; }


bool SpriteAnimation::Load( File* stream )
{
