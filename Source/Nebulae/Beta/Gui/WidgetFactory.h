...
public:
  ...
  virtual ButtonControl* CreateButton( int32 x, int32 y, int32 width, int32 height, const std::string& str,
                                       const std::shared_ptr<Font>& font, Colour colour, Colour textColour = CLR_BLACK,
                                       uint32 flags = INTERACTIVE ) const;

  /** Returns a new StaticGraphic. */
  virtual StaticGraphic* CreateStaticGraphic( int32 x, int32 y, int32 width, int32 height, SubTexture* texture,
                                              uint32 flags = 0 ) const;


  /** Returns a new EditControl. */
  virtual EditControl* CreateEditControl( int32 x, int32 y, int32 w, const std::string& str,
                                          const std::shared_ptr<Font>& font, Colour colour,
                                          Colour text_colour = CLR_BLACK, Colour interior = CLR_ZERO,
                                          uint32 flags = INTERACTIVE ) const;
  ...
  virtual Slider* CreateSlider( int32 x, int32 y, int32 w, int32 h, Real min, Real max /*, Orientation orientation,
                                 SliderLineStyle style, Clr color*/
                                ,
                                int32 tab_width, int32 line_width = 5, uint32 flags = INTERACTIVE ) const;
  ...
  virtual ButtonControl* CreateSliderTabButton( int32 x, int32 y, int32 w, int32 h, const std::string& str,
                                                ...
                                                Colour text_color = CLR_BLACK, uint32 flags = INTERACTIVE ) const;
  //@}
  ...
  //                                              Clr button_color, Clr text_color, int32 buttons, const std::string&
  //                                              zero = "", const std::string& one = "", const std::string& two = "")
  //                                              const;
  ...
  //                                              Clr color, Clr border_color, Clr button_color, Clr text_color, int32
  //                                              buttons, const std::string& zero = "", const std::string& one = "",
