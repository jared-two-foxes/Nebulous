...
/** \brief An invisible Widget subclass that arranges its child Widgets.
    ...
    of 0 will not change size at all.  The excePointion to this is when all rows
    ...
    between individual Widgets in the layout, but does not add to the margin
    ...
    will have an effect on the minimum size of a cell, even an emPointy one, if
    it is \a greater than the row or column minimum for that cell.  So an
    emPointy layout with 5 columns, a border margin of 3, and a cell margin of 2
