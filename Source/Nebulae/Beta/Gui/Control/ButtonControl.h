...
public:
  ...
  void SetUnpressedGraphic(
    const SubTexture& texture ); /** Sets the Texture to be used as the image of the button when unpressed. */
  void SetPressedGraphic(
    const SubTexture& texture ); /** Sets the Texture to be used as the image of the button when pressed. */
  //@}
