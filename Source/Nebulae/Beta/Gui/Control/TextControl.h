...
public:
  /** \name Structors */ ///@{
  /** Ctor. */
  TextControl( const WidgetFactory& factory, int x, int y, int w, int h, const std::string& str,
               const std::shared_ptr<Font>& font, Colour color = CLR_BLACK, Flags<TextFormat> format = FORMAT_NONE,
               uint32 flags = 0 );
