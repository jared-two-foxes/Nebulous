#ifndef NEBULAE_BETA_OVERLAY_OVERLAYRENDERER_H_
#define NEBULAE_BETA_OVERLAY_OVERLAYRENDERER_H_
...
public:
  ...
  void BeveledRectangle( Point ul, Point lr, Colour color, Colour borderColor, bool up, uint32 bevelThick = 2,
                         bool bevelLeft = true, bool bevelTop = true, bool bevelRight = true,
                         bool bevelBottom = true ) const;
...
protected:
  ...
  void Rectangle( RenderSystemPtr renderDevice, Nebulae::Point ul, Nebulae::Point lr, Colour colour,
                  Colour borderColour1, Colour borderColour2, uint32 bevelThick, bool bevelLeft, bool bevelTop,
...
#endif // NEBULAE_BETA_OVERLAY_OVERLAYRENDERER_H_
