...
const UniformDefinitionMap& UniformParameters::GetUniformDefinitions() const { return m_definitions; }


float* UniformParameters::GetFloatPointer( std::size_t pos ) { /*_markDirty();*/ return &m_realUniformBuffer[pos]; }


const float* UniformParameters::GetFloatPointer( std::size_t pos ) const { return &m_realUniformBuffer[pos]; }


int* UniformParameters::GetIntPointer( std::size_t pos ) { /*_markDirty();*/ return &m_intUniformBuffer[pos]; }


const int* UniformParameters::GetIntPointer( std::size_t pos ) const { return &m_intUniformBuffer[pos]; }


void UniformParameters::AddUniformDefinition( const std::string& name, UniformType uniformType, std::size_t arraySize )
{
...
void UniformParameters::RemoveUniformDefinition( const std::string& name )
{
...
void UniformParameters::RemoveAllUniformDefinitions()
{
  m_definitions.clear();
...
void UniformParameters::SetNamedUniform( const std::string& name, Real val ) { SetNamedUniform( name, &val, 1 ); }


void UniformParameters::SetNamedUniform( const std::string& name, int val ) { SetNamedUniform( name, &val, 1 ); }


void UniformParameters::SetNamedUniform( const std::string& name, const Vector4& vec )
{
  SetNamedUniform( name, vec.ptr(), 4 );
}


void UniformParameters::SetNamedUniform( const std::string& name, const Colour& colour )
{
  Real buffer[4];
...
void UniformParameters::SetNamedUniform( const std::string& /*name*/, const Matrix4& /*m*/ )
{ /*SetNamedUniform( name, m[0], 16 );*/ }


void UniformParameters::SetNamedUniform( const std::string& /*name*/, const Matrix4* /*m*/, std::size_t /*numEntries*/ )
{ /*SetNamedUniform( name, m[0][0], 16 * numEntries );*/
}


void UniformParameters::SetNamedUniform( const std::string& name, const float* val, std::size_t count )
{
  UniformDefinitionMap::const_iterator i = m_definitions.find( name );
  if ( i != m_definitions.end() )
  {
...
void UniformParameters::SetNamedUniform( const std::string& name, const double* val, std::size_t count )
{
  UniformDefinitionMap::const_iterator i = m_definitions.find( name );
  if ( i != m_definitions.end() )
  {
...
void UniformParameters::SetNamedUniform( const std::string& name, const int* val, std::size_t count )
{
  UniformDefinitionMap::const_iterator i = m_definitions.find( name );
  if ( i != m_definitions.end() )
  {
