#ifndef NEBULAE_BETA_RENDERQUEUE_SORTKEY_H_
#define NEBULAE_BETA_RENDERQUEUE_SORTKEY_H_
...
/// Opaque (non-transparent) items sort before transparent ones within the
/// same layer
...
#endif // NEBULAE_BETA_RENDERQUEUE_SORTKEY_H_
