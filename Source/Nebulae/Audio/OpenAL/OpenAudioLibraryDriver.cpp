...
OpenAudioLibraryDriver::OpenAudioLibraryDriver() : m_device( NULL ), m_context( NULL ) {}


OpenAudioLibraryDriver::~OpenAudioLibraryDriver() { Shutdown(); }


bool OpenAudioLibraryDriver::Init()
{
  //
...
void OpenAudioLibraryDriver::Shutdown()
{
  if ( m_context )
...
AudioBufferInterface* OpenAudioLibraryDriver::CreateDriverBuffer() { return new OpenAudioLibraryBuffer( 0 ); }


void OpenAudioLibraryDriver::DestroyDriverBuffer( AudioBufferInterface* driverBuffer ) { assert( 0 ); }


AudioEmitterInterface* OpenAudioLibraryDriver::CreateDriverEmitter()
{
...
void OpenAudioLibraryDriver::DestroyDriverEmitter( AudioEmitterInterface* emitter ) { assert( 0 ); }


void OpenAudioLibraryDriver::SetMasterVolume( float volume )
{
