...
/// Default Constructor
///
OpenAudioLibraryBuffer::OpenAudioLibraryBuffer( uint32 size ) : m_id( 0 ) {}
...
bool OpenAudioLibraryBuffer::Initiate()
///
...
bool OpenAudioLibraryBuffer::Fill( AudioFormat format, void* data, uint32 size, uint32 frequency )
///
...
bool OpenAudioLibraryBuffer::Destroy()
///
