#ifndef NEBULAE_AUDIO_OPENAL_OPENAUDIOLIBRARYDRIVER_H_
#define NEBULAE_AUDIO_OPENAL_OPENAUDIOLIBRARYDRIVER_H_
...
#endif // NEBULAE_AUDIO_OPENAL_OPENAUDIOLIBRARYDRIVER_H_