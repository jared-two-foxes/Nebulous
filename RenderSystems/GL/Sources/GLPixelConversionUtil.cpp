...
GLenum GLPixelConversionUtil::GetGLOriginFormat( PixelFormat mFormat )
{
  switch ( mFormat )
  {
  case PF_A8:
...
GLenum GLPixelConversionUtil::GetGLOriginDataType( PixelFormat mFormat )
{
  switch ( mFormat )
  {
  case PF_A8:
...
GLenum GLPixelConversionUtil::GetGLInternalFormat( PixelFormat pixelFormat )
{
  switch ( pixelFormat )
  {
  case PF_L8:
...
GLenum GLPixelConversionUtil::GetClosestGLInternalFormat( PixelFormat pixelFormat )
{
  GLenum format = GetGLInternalFormat( pixelFormat );
  if ( format != GL_NONE )
  {
    return format;
  }
...
PixelFormat GLPixelConversionUtil::GetClosestPixelFormat( GLenum fmt )
{
  switch ( fmt )
  {
  case GL_LUMINANCE8:
...
size_t GLPixelConversionUtil::GetMaxMipmaps( size_t width, size_t height, size_t depth, PixelFormat format )
{
  size_t count = 0;
