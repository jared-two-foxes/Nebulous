#ifndef NEBULAE_RENDERSYSTEMS_GLES2_SHARED_GLES2HARDWAREBUFFERIMPL_H_
#define NEBULAE_RENDERSYSTEMS_GLES2_SHARED_GLES2HARDWAREBUFFERIMPL_H_
...
public:
  GLES2HardwareBufferImpl( const Flags<HardwareBufferUsage>& usage, std::size_t sizeInBytes,
  ...
  virtual void WriteData( std::size_t offset, std::size_t length, const void* pSource,
...
#endif // NEBULAE_RENDERSYSTEMS_GLES2_SHARED_GLES2HARDWAREBUFFERIMPL_H_