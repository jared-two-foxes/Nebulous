...
GLES2RenderBuffer::GLES2RenderBuffer() : m_handle( 0 ) {}

GLES2RenderBuffer::~GLES2RenderBuffer() {}

GLuint GLES2RenderBuffer::GetHandle() const { return m_handle; }

void GLES2RenderBuffer::Bind() { glBindRenderbuffer( GL_RENDERBUFFER, m_handle ); }

bool GLES2RenderBuffer::Load()
{
  glGenRenderbuffers( 1, &m_handle );
  return true;
}

bool GLES2RenderBuffer::Unload()
{
