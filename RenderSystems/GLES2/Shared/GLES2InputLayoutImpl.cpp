...
GLES2InputLayoutImpl::GLES2InputLayoutImpl( const Nebulae::VertexDeceleration* pVertexDecl,
                                            const Nebulae::HardwareShader* pVertexShader )
...
bool GLES2InputLayoutImpl::Load() { return true; }

void GLES2InputLayoutImpl::Unbind()
{
...
void GLES2InputLayoutImpl::Bind( ProgramObject* programObject )
{
  //
...
GLint GLES2InputLayoutImpl::BindAttribute( GLuint iHandle, const char* attribute_name, GLint iSize, GLenum iFormat,
                                           int32 iStride, std::size_t offset )
{
