...
public:
  ...
  virtual HardwareBufferImpl* CreateBufferImpl( HardwareBufferUsage usage, std::size_t sizeInBytes,
  ...
  // pipeline functions
  virtual void SetVertexBuffers( int iSlot, /*int iCount,*/ HardwareBuffer* pBuffers, std::size_t iStride,
                                 std::size_t iOffset ) override;
