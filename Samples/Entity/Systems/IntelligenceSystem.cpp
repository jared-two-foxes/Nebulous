...
void IntelligenceSystem::Process( Real elapsed, std::vector<Entity*>& entities )
///
...
Vector4 IntelligenceSystem::Seek( Entity& entity, const Vector4& position ) const
///
...
Vector4 IntelligenceSystem::Flee( Entity& entity, const Vector4& position ) const
///
...
Vector4 IntelligenceSystem::Alignment( Entity& entity, const std::vector<Entity*>& neighbors ) const
...
Vector4 IntelligenceSystem::Cohesion( Entity& entity, const std::vector<Entity*>& neighbors ) const
/// @todo [jared.watt 14-08-2013] This function needs documentation.
{
  Vector4 steeringForce = Vector4( 0, 0, 0, 0 );
...
Vector4 IntelligenceSystem::Separation( Entity& entity, const std::vector<Entity*>& neighbors ) const
/// @todo [jared.watt 14-08-2013] This function needs documentation.
{
  PlacementComponent& placement = static_cast<Boid*>( &entity )->GetPlacement();
  Vector4 steeringForce = Vector4( 0, 0, 0, 0 );
